...
The first chatbot to provide accessibility to open government data, enabling citizens to follow their politicians and know what they are doing, making the exercise of political participation friendly. 

## GitHub

Clone Repository:

* `git clone https://github.com/jeanmdias/anovavoz`

## Bootstrap

Wingman Bootstrap Theme 1.0.5
